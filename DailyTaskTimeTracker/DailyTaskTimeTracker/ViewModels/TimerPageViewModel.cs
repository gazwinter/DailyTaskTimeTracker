...
namespace DailyTaskTimeTracker.ViewModels
{
    ...
    {
        public TimerPageViewModel(INavigationService navigationService, IAccountService accountService, IDailyTaskTimeTrackerRepository dailyTaskTimeTrackerRepository) : 
